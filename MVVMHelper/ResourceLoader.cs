...
namespace MVVMHelper
{
    public class ResourceLoader : DynamicObject
    {
        ...
        private const string DefaultResourcesSuffix = "Resources";
        ...
        public ResourceLoader()
            : this(CultureInfo.InvariantCulture, DefaultResourcesSuffix, null)
        { }

        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceLoader"/> class.
        /// </summary>
        public ResourceLoader(CultureInfo InitCulture, string ResourceSuffix, ResourceManager rm)
        {
        ...
        public override bool TryGetMember(GetMemberBinder binder, out object result)
        {
            ...
            if (result != null && result.GetType() == typeof(Bitmap))
            {
                Bitmap currentBmp = result as Bitmap;
                BitmapSource src = BitmapToImageSourceConverter.ConvertToImageSource(currentBmp);
                result = src;
            }
